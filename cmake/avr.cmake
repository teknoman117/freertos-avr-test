...
function(avr_add_extra_outputs TARGET)
    ...
    add_custom_target(${TARGET}-hex ALL avr-objcopy -R .eeprom -O ihex ${TARGET}.elf ${TARGET}.hex DEPENDS ${TARGET}-strip)
    add_custom_target(${TARGET}-eeprom avr-objcopy -j .eeprom --set-section-flags=.eeprom="alloc,load" --change-section-lma .eeprom=0 -O ihex ${TARGET}.elf ${TARGET}.eep DEPENDS ${TARGET}-strip)
